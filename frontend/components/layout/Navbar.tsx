                ...
                return (
                  ...
                  >
                    <span className="relative z-10 flex items-center gap-2">
                      <link.icon
                        className={`h-4 w-4 transition-transform duration-300 group-hover:scale-110 ${isActive(link.href) ? "text-primary" : "text-muted-foreground group-hover:text-primary"}`}
                      />
                      {link.label}
                    </span>
                  </Link>
            ...
            {isAuthenticated && user ? (
              <div className="relative" ref={profileRef}>
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-3.5 w-3.5 text-muted-foreground transition-transform duration-300 ${isProfileOpen ? "rotate-180" : ""}`}
                  />
                </button>
